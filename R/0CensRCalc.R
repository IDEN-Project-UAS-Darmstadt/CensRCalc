...
#' S_T*|X = 1-F_T*|X}
#' and the random censoring time be
#' \mjeqn{C_{\text{rnd}}\mid\lambda_{C_{\text{rnd}}}\sim F_{C_{\text{rnd}}
#' \mid\lambda_{C_{\text{rnd}}}}}{C_rnd|lambda_C_rnd~F_C_rnd|lambda_C_rnd}
#' with survival function
#' \mjeqn{S_{C_{\text{rnd}}\mid\lambda_{C_{\text{rnd}}}}=1-F_{C_{\text{rnd}}
#' \mid\lambda_{C_{\text{rnd}}}}}{S_C(t|lambda_C_rnd)=1-F_C(t|lambda_C_rnd)},
#' where \mjeqn{\lambda_{C_{\text{rnd}}}}{lambda_C_rnd}
#' is the random censoring parameter of interest. Administrative censoring
#' occurs at time \mjeqn{\tau_{\text{adm}}}{tau_adm}. Accrual takes place over
...
#' \mjeqn{C_{\text{adm}}=\tau_{\text{adm}}-R}{C_adm=tau_adm-R}. Hence,
#' \mjeqn{C_{\text{adm}}\sim U(\tau_{\text{adm}}-\tau_{\text{acc}},
#' \tau_{\text{adm}})}{C_adm~U(tau_adm-tau_acc, tau_adm)}.
#'
...
#' S_{T^{*}\mid\mathbf{X}}(c_{\text{rnd}})
#' f_{C_{\text{rnd}}\mid\lambda_{C_{\text{rnd}}}}(c_{\text{rnd}})dc_{\text{rnd}}
#' + \\\\\\
#' &\int_{\tau_{\text{adm}} - \tau_{\text{acc}}}^{\tau_{\text{adm}}}
#' S_{T^{*}\mid\mathbf{X}}(c_{\text{rnd}})S_{C_{\text{adm}}}(c_{\text{rnd}})
#' f_{C_{\text{rnd}}\mid\lambda_{C_{\text{rnd}}}}(c_{\text{rnd}})dc_{\text{rnd}}
#' + \\\\\\
#' &\int_{\tau_{\text{adm}} - \tau_{\text{acc}}}^{\tau_{\text{adm}}}
#' S_{T^{*}\mid\mathbf{X}}(C_{\text{adm}})
#' S_{C_{\text{rnd}}\mid\lambda_{C_{\text{rnd}}}}(C_{\text{adm}})
...
#' censoring (\mjeqn{\tau_{\text{adm}}=\infty}{tau_adm=Inf}). See the package
#' vignette \code{vignette("full_details", package = "CensRCalc")} for details.
#'
